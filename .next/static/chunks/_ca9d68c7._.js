...
"[project]/hooks/useGroups.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useCreateGroup() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useCreateGroup.useMutation": (body)=>fetch('/api/groups', {
                    method: 'POST',
                    headers: {
                    ...
                    "useCreateGroup.useMutation": (r)=>r.json()
                }["useCreateGroup.useMutation"])
        }["useCreateGroup.useMutation"],
        onSuccess: {
            "useCreateGroup.useMutation": ()=>qc.invalidateQueries({
                    queryKey: [
                        'groups'
                    ]
                })
...
_s1(useCreateGroup, "ec0A66mtyLA0kdwNsMUsaWj/EHM=", false, function() {
    return [
...
function useUpdateGroup() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useUpdateGroup.useMutation": (param)=>{
                let { id, patch } = param;
                return fetch("/api/groups/".concat(id), {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    ...
                    "useUpdateGroup.useMutation": (r)=>r.json()
                }["useUpdateGroup.useMutation"]);
            }
        }["useUpdateGroup.useMutation"],
        onMutate: {
            "useUpdateGroup.useMutation": async (param)=>{
                let { id, patch } = param;
                ...
                qc.setQueryData([
                    ...
                    "useUpdateGroup.useMutation": (old)=>old ? old.map({
                            "useUpdateGroup.useMutation": (g)=>g.id === id ? {
                                    ...g,
                                    ...patch
                                } : g
                        }["useUpdateGroup.useMutation"]) : old
                }["useUpdateGroup.useMutation"]);
                qc.setQueryData([
                    'group',
                    id
                ], {
                    "useUpdateGroup.useMutation": (old)=>old ? {
                            ...old,
                            ...patch
                        } : old
                }["useUpdateGroup.useMutation"]);
        ...
        onError: {
            "useUpdateGroup.useMutation": (_err, param, ctx)=>{
                let { id } = param;
                if (ctx === null || ctx === void 0 ? void 0 : ctx.prevGroups) qc.setQueryData([
                    'groups'
                ], ctx.prevGroups);
                if (ctx === null || ctx === void 0 ? void 0 : ctx.prevGroup) qc.setQueryData([
                    'group',
                    id
                ], ctx.prevGroup);
            }
        ...
        onSettled: {
            "useUpdateGroup.useMutation": (_data, _err, param)=>{
                let { id } = param;
...
_s2(useUpdateGroup, "ec0A66mtyLA0kdwNsMUsaWj/EHM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
function useDeleteGroup() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useDeleteGroup.useMutation": (id)=>fetch("/api/groups/".concat(id), {
                    method: 'DELETE'
                }).then({
                    "useDeleteGroup.useMutation": (r)=>r.json()
                }["useDeleteGroup.useMutation"])
        }["useDeleteGroup.useMutation"],
        onSuccess: {
            "useDeleteGroup.useMutation": ()=>qc.invalidateQueries({
                    queryKey: [
                        'groups'
                    ]
                })
...
_s3(useDeleteGroup, "ec0A66mtyLA0kdwNsMUsaWj/EHM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
"[project]/lib/dates.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/scoring.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function oeWindow(g) {
    ...
    const oeDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(oeAnchor);
    const oeEndDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(g.oeEndDate);
...
function buildVM(g) {
    const rd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(g.renewalDate);
    ...
    const ci = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(g.nextCheckIn);
    const checkInDue = ci != null && ci < 0;
    const checkInText = g.nextCheckIn ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fmt"])(g.nextCheckIn) : '—';
    const fu = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(g.followUpDate);
    const followUpDue = fu != null && fu <= 0;
    const followUpText = g.followUpDate ? fu < 0 ? Math.abs(fu) + 'd ago' : fu === 0 ? 'Today' : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fmt"])(g.followUpDate) : '';
    ...
    (g.workflows || []).forEach((w)=>(w.sections || []).forEach((sec)=>(sec.tasks || []).forEach((t)=>{
                ...
                const du = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(t.dueDate);
                if (du == null) return;
                if (du < 0) wfOverdue++;
    ...
    var _daysUntil;
    const monitorDue = !!g.monitorMonthly && (g.lastMonitor == null || ((_daysUntil = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(g.lastMonitor)) !== null && _daysUntil !== void 0 ? _daysUntil : 0) <= -30);
    let score = 0;
    const reasons = [];
    if (followUpDue) {
        score += 130;
    ...
    const snz = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysUntil"])(g.snoozedUntil);
    const snoozed = snz != null && snz > 0;
    const win = oeWindow(g);
    const oeDateText = g.oeStartDate ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fmt"])(g.oeStartDate) + (g.oeEndDate ? ' – ' + (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fmt"])(g.oeEndDate) : '') : 'Dates not set';
    let actionDetail = '';
    let dueText = '';
    let dueTone = 'neutral';
    if (followUpDue) {
        ...
        actionDetail = 'Workflow task overdue — ' + (nextWfTaskLabel !== null && nextWfTaskLabel !== void 0 ? nextWfTaskLabel : 'see tasks');
        ...
        actionDetail = 'Workflow task coming due — ' + (nextWfTaskLabel !== null && nextWfTaskLabel !== void 0 ? nextWfTaskLabel : 'see tasks');
        dueText = 'Task due';
        dueTone = 'warn';
...
function SidebarInner() {
    ...
    const { data: groups = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useGroups$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGroups"])();
    const counts = groups.reduce((acc, g)=>{
        const vm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["buildVM"])(g);
    ...
    const currentFilter = (_searchParams_get = searchParams.get('filter')) !== null && _searchParams_get !== void 0 ? _searchParams_get : '';
    const navItems = [
        {
            label: 'Dashboard',
            href: '/dashboard'
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: pipelineItems.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/groups?filter=".concat(item.filter),
                                className: [
...
_s(SidebarInner, "2I0wYmgHPOrshjDStA6k5GxNDoY=", false, function() {
    return [
...
function Sidebar() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        fallback: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SidebarInner, {}, void 0, false, {
            fileName: "[project]/components/layout/Sidebar.tsx",
            lineNumber: 159,
            columnNumber: 7
        }, this)
...
_c1 = Sidebar;
var _c, _c1;
__turbopack_context__.k.register(_c, "SidebarInner");
...
function Header() {
    ...
    const { search, setSearch, setShowAddGroup } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUIStore"])();
    ...
    const todayFormatted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fmt"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["todayISO"])());
...
_s(Header, "UaeN2cAqL4+/rn1RPulxsSQVyjQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
...
"[project]/components/groups/AddGroupModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AddGroupModal() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { showAddGroup, setShowAddGroup } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUIStore"])();
    const createGroup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useGroups$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateGroup"])();
    ...
    const [renewalDate, setRenewalDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [currentBM, setCurrentBM] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    async function handleSubmit(e) {
        ...
        if (result === null || result === void 0 ? void 0 : result.id) {
            router.push("/groups/".concat(result.id));
        }
    }
    const statusOptions = [
        {
...
_s(AddGroupModal, "np3pdFaEWCHt+s9HQz5CKQJpEfs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUIStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useGroups$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateGroup"]
    ];
});
_c = AddGroupModal;
var _c;
__turbopack_context__.k.register(_c, "AddGroupModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_ca9d68c7._.js.map