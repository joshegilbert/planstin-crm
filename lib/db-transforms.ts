...
export function transformGroup(row: any): Group {
  return {
    ...
    handoffWindowStart: row.handoff_window_start || null,
    handoffWindowEnd: row.handoff_window_end || null,
...
export function groupPatchToDb(patch: Record<string, any>): Record<string, any> {
  const map: Record<string, string> = {
    ...
    handoffWindowStart: 'handoff_window_start',
    handoffWindowEnd: 'handoff_window_end',
