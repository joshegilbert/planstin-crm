module.exports = [
"[project]/.next-internal/server/app/api/templates/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/templates/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    ...
    const { data, error } = await supabase.from('workflow_templates').update(allowed).eq('id', id).select().single();
...
async function DELETE(_, { params }) {
    ...
    const { data: tpl } = await supabase.from('workflow_templates').select('builtin').eq('id', id).single();
    if (tpl?.builtin) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e00fa39a._.js.map